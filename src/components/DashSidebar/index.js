  ...
  return (
    ...
    >
      ...
      {/* <List>
        ...
        >{`Setttings`}</ListSubheader>
        <Divider className={classes.whiteDivider} />
        <ListItem
          button
          onClick={() => navigate(6, "/changepassword")}
          className={clsx(
            6 === selectedIndex ? classes.selectedListItem : undefined
          )}
        >
          <ListItemIcon>
            {" "}
        ...
        <ListItem
          button
          onClick={() => navigate(7, "/logout")}
          className={clsx(
            7 === selectedIndex ? classes.selectedListItem : undefined
          )}
        >
          <ListItemIcon>
            {" "}
          ...
          <ListItemText className={classes.itemTitle} primary={"Logout"} />
        </ListItem>
      </List> */}
    </Drawer>
  );
